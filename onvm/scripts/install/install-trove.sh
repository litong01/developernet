...
iniset /etc/trove/trove-taskmanager.conf DEFAULT nova_proxy_admin_user admin
iniset /etc/trove/trove-taskmanager.conf DEFAULT nova_proxy_admin_pass $1
iniset /etc/trove/trove-taskmanager.conf DEFAULT nova_proxy_admin_tenant_name service
iniset /etc/trove/trove-taskmanager.conf DEFAULT taskmanager_manager 'trove.taskmanager.manager.Manager'
iniset /etc/trove/trove-taskmanager.conf DEFAULT trove_auth_url "http://${leap_logical2physical_keystone}:5000/v2.0"
...
iniset /etc/trove/trove-taskmanager.conf DEFAULT nova_proxy_admin_tenant_name service
inidelete /etc/trove/trove-taskmanager.conf DEFAULT nova_proxy_admin_tenant_id
...
iniset /etc/trove/trove-guestagent.conf DEFAULT nova_proxy_admin_user admin
iniset /etc/trove/trove-guestagent.conf DEFAULT nova_proxy_admin_pass $1
iniset /etc/trove/trove-guestagent.conf DEFAULT nova_proxy_admin_tenant_name service
